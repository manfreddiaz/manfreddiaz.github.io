...
- remove reference to blog page in our [\_pages/_dropdown.md](_pages/_dropdown.md)
...
- remove reference to publications page in our [\_pages/_dropdown.md](_pages/_dropdown.md)
